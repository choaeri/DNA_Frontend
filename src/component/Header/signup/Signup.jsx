        ...
        <Card className="accountCnt signup" title={<span className="tit">Sign Up</span>}>
          <Form {...layout} onFinish={onClickSignupBtn} autoComplete={"false"}>
            <Form.Item {...tailLayout}>
              <button className="accountBtn google" value="google" onClick={handleSignup}>
            ...
            <Form.Item {...tailLayout}>
              <button className="accountBtn isg" value="instagram" onClick={handleSignup}>
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
            ...
            <Form.Item {...tailLayout}>
              <button className="accountBtn fb" value="facebook" onClick={handleSignup}>
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
