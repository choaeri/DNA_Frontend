				...
				<div className="InfoAreas">
					...
					<div className="infoCnt">
						...
						<div className='spots'>
							...
							<span>{facilityCount.filter((obj)=>obj.locationId === currentArea.locationId)[0].facilityCount} spots</span>
						</div>
						{/* 지역 이미지 */}
						<div className='img'>
							<img src="/img/workation1.jpg" alt="/img/workation1.jpg" />
							<img src="/img/workation2.jpg" alt="/img/workation2.jpg" />
							<img src="/img/workation3.jpg" alt="/img/workation3.jpg" />
							<img src="/img/workation4.jpg" alt="/img/workation4.jpg" />
						</div>
						<AddSchedule />
					</div>
				</div>
