...
export default function Popup () {
  ...
  return (
    <>
      <Modal 
        open={isPopup} onClose={() => setIsPopup(false)}
      >
        <section className="popupSection">
          <div className="popupModal">
            <div className="popupHeader">
              <svg className="closeBtn" onClick={() => setIsPopup(false)} xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 40 40" fill="none">
