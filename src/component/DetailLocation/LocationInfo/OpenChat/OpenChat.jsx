...
export default function OpenChat() {
  ...
  return (
    <div
      className="chat"
      style={isLoggedIn ? { height: "248px" } : { height: "fit-content" }}
    >
      <div className="header">
        Open Talk
        {isLoggedIn ? (
          <span className="participantCount">{participantCount} people</span>
        ) : null}
      </div>
      {isLoggedIn ? (
        <>
